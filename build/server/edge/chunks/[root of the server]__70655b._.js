...
const isPublicPath = (path)=>PUBLIC_PATHS.some((publicPath)=>path.startsWith(publicPath));
const isProtectedPath = (path)=>PROTECTED_PATHS.some((protectedPath)=>path.startsWith(protectedPath));
