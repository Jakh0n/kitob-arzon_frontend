...
const BuyButton = ({ isLoggedIn })=>{
    ...
    const onBuy = ()=>{
        if (!isLoggedIn) {
            router.push('/sign-in');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])('Iltimos, tizimga kiring');
        }
    };
...
//# sourceMappingURL=app_%28root%29_product_%5BproductId%5D_c99abf._.js.map